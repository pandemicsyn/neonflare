...
__export(index_exports, {
  ...
  CompositeEnrichmentProvider: () => CompositeEnrichmentProvider,
  CompositeTelemetryProvider: () => CompositeTelemetryProvider,
  Config: () => Config,
  ConfigurationManager: () => ConfigurationManager,
  ConsoleTelemetryProvider: () => ConsoleTelemetryProvider,
  ContextInjectionMiddleware: () => ContextInjectionMiddleware,
  CustomEnrichmentProvider: () => CustomEnrichmentProvider,
  DefaultTelemetryManager: () => DefaultTelemetryManager,
  EnrichmentManager: () => EnrichmentManager,
  EnvironmentEnrichmentProvider: () => EnvironmentEnrichmentProvider,
  Errors: () => Errors,
  GeographicEnrichmentProvider: () => GeographicEnrichmentProvider,
  MCPError: () => MCPError,
  MCPErrorBoundary: () => MCPErrorBoundary,
  MCPErrorFilter: () => MCPErrorFilter,
  MCPErrorHandler: () => MCPErrorHandler,
  MCPErrorRecovery: () => MCPErrorRecovery,
  MCPErrorType: () => MCPErrorType,
  MCPInstrumentation: () => MCPInstrumentation,
  MCPTracker: () => MCPTracker,
  MemoryTelemetryProvider: () => MemoryTelemetryProvider,
  OTLPTTelemetryProvider: () => OTLPTTelemetryProvider,
  PerformanceMonitor: () => PerformanceMonitor,
  PerformanceTimer: () => PerformanceTimer,
  TelemetryProviderFactory: () => TelemetryProviderFactory,
  UserContextEnrichmentProvider: () => UserContextEnrichmentProvider,
  createBusinessAttributes: () => createBusinessAttributes,
  createCorrelationAttributes: () => createCorrelationAttributes,
  createDatabaseAttributes: () => createDatabaseAttributes,
  createErrorAttributes: () => createErrorAttributes,
  createHTTPRequestAttributes: () => createHTTPRequestAttributes,
  createMCPAttributes: () => createMCPAttributes,
  createMCPInstrumentation: () => createMCPInstrumentation,
  createMetricAttributes: () => createMetricAttributes,
  createPerformanceAttributes: () => createPerformanceAttributes,
  createResourceAttributes: () => createResourceAttributes,
  createSecurityAttributes: () => createSecurityAttributes,
  createSpanEvent: () => createSpanEvent,
  createSpanLink: () => createSpanLink,
  createTimingAttributes: () => createTimingAttributes,
  createUserAttributes: () => createUserAttributes,
  extractContextFromArgs: () => extractContextFromArgs,
  extractCorrelationInfo: () => extractCorrelationInfo,
  filterAttributes: () => filterAttributes,
  formatAttributesForLogging: () => formatAttributesForLogging,
  generateCorrelationId: () => generateCorrelationId,
  getConfigurationManager: () => getConfigurationManager,
  getContextInjector: () => getContextInjector,
  getEnrichmentManager: () => getEnrichmentManager,
  getErrorHandler: () => getErrorHandler,
  getInstrumentation: () => getInstrumentation,
  getPerformanceMonitor: () => getPerformanceMonitor,
  getTelemetryManager: () => getTelemetryManager,
  getTracker: () => getTracker,
  hasContextInjection: () => hasContextInjection,
  injectContextIntoSchema: () => injectContextIntoSchema,
  isValidAttributeKey: () => isValidAttributeKey,
  measurePerformance: () => measurePerformance,
  measureSyncPerformance: () => measureSyncPerformance,
  mergeAttributes: () => mergeAttributes,
  resetConfigurationManager: () => resetConfigurationManager,
  resetEnrichmentManager: () => resetEnrichmentManager,
  resetErrorHandler: () => resetErrorHandler,
  resetPerformanceMonitor: () => resetPerformanceMonitor,
  resetTelemetryManager: () => resetTelemetryManager,
  sanitizeAttributeKeys: () => sanitizeAttributeKeys,
  sanitizeAttributeValue: () => sanitizeAttributeValue,
  sanitizeAttributes: () => sanitizeAttributes,
  sanitizeConnectionString: () => sanitizeConnectionString,
  setConfigurationManager: () => setConfigurationManager,
  setEnrichmentManager: () => setEnrichmentManager,
  setErrorHandler: () => setErrorHandler,
  setPerformanceMonitor: () => setPerformanceMonitor,
  setTelemetryManager: () => setTelemetryManager,
  stripContextFromArgs: () => stripContextFromArgs,
  trackmcp: () => trackmcp,
  withPerformanceMonitoring: () => withPerformanceMonitoring,
  withSyncPerformanceMonitoring: () => withSyncPerformanceMonitoring
});
...
var MCPTracker = class {
  ...
  initializeTracer() {
    const resource = import_resources.Resource.default().merge(new import_resources.Resource({
      [import_semantic_conventions.SemanticResourceAttributes.SERVICE_NAME]: this.config.serviceName || "mcp-server",
      [import_semantic_conventions.SemanticResourceAttributes.SERVICE_VERSION]: this.config.serviceVersion || "1.0.0",
      [import_semantic_conventions.SemanticResourceAttributes.TELEMETRY_SDK_LANGUAGE]: "nodejs",
      [import_semantic_conventions.SemanticResourceAttributes.TELEMETRY_SDK_NAME]: "opentelemetry"
    }));
    this.tracer = import_api.trace.getTracer("neonflare-mcp", this.config.serviceVersion);
  }
  /**
  ...
  endMCPSpan(operationId, result) {
    ...
    if (!result.success && result.error) {
      ...
      span.setStatus({ code: import_api.SpanStatusCode.ERROR, message: result.error.message });
    } else {
  ...
  async shutdown() {
    for (const [operationId, span] of this.activeSpans) {
      span.setStatus({ code: import_api.SpanStatusCode.ERROR, message: "Tracker shutdown" });
      span.end();
    }
